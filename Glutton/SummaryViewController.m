...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.rankValueLabel.text = [NSString stringWithFormat:@"%lu",(long)[defaults integerForKey:@"swipeCount"]];
    self.friendsValueLabel.text = [NSString stringWithFormat:@"%lu", (long)[defaults integerForKey:@"rated"]];
    ...
    NSString *points = [NSString stringWithFormat:@"%lu", (long)[defaults integerForKey:@"points"]];
