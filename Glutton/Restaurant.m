...
- (instancetype)initWithId:(NSString *)id
           ...
           snippetImageURL:(NSString *)snippetImageURL
                   snippet:(NSString *)snippet
                    curDate:(NSDate *)curDate
                    isSeenDic:(NSNumber *)isSeenDic{
    self = [super init];
    if (self) {
        _id = id; //nonnull
        ...
        _snippet = snippet ?: @"";
        _curDate = curDate ?: [NSDate date];
        _isSeenDic = isSeenDic;
    }
    return self;
}
...
+ (NSDictionary *)serialize:(Restaurant *)restaurant {
    return @{
        ...
        @"date" : restaurant.curDate,
        @"isseendic" : restaurant.isSeenDic
             };
}
...
+ (Restaurant *)deserialize:(NSDictionary *)r {
    return [[Restaurant alloc]
            ...
            curDate:[r objectForKey:@"date"]
            isSeenDic:[r objectForKey:@"isseendic"]
            ];
}
